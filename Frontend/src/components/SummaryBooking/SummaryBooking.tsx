...
const SummaryBooking = () => {
  ...
  return (
    <div className="Gradient-T p-5 w-[1200px] h-[500px] rounded-[15px]">
      <h1 className="text-center text-[20px] text-white "> Resumen de la Reserva</h1>
          ...
          <div className="flex flex-col bg-white w-[580px] h-[405px] rounded-l-[10px] me-3 ">
            <div className="flex justify-between h-1/3 px-6 border-b-[1px] border-black">
              <div className="flex flex-col my-auto">
                ...
                <p className="text-text text-[20px]">30 de marzo de 2024 a las 16:00</p>
            ...
            <div className="flex justify-between h-1/3 px-6 border-b-[1px] border-black">
              <div className="flex flex-col my-auto">
                ...
                <p className="text-text text-[20px]">01 de abril de 2024 a las 16:00</p>
                <p className="text-text text-[14px]">Aeropuerto - Mendoza</p>
              </div>
              <div className="flex justify-center items-center ">
            ...
            <div className="flex justify-between h-1/3 px-6">
              <div className="flex flex-col my-auto">
                ...
                <p className="text-text text-[20px]">Grupo PX - 4x4 Especial Automático</p>
                <p className="text-text text-[14px]">Chevrolet S10X 2.8 Automática</p>
              </div>
              <div className="flex justify-center items-center ">
