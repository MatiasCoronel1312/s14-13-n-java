...
const navbar = () => {
  return (
    <div className="h-[80px] lg:w-[90%] bg-[#707070] flex items-center justify-around">
      ...
      <button className='text-primary border-2 border-primary w-[136px] h-[44px] rounded-ss-[5px] rounded-ee-[5px] cursor-pointer hover:bg-primary hover:text-text'>Log in</button>
    </div>
  )
}
